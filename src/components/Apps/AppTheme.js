  ...
  return (
    <div className="ui-app" onClick={onClick}>
        <div className="ui-app-meta">
          ...
          <div className="ui-app-meta-icon ui-app-meta-icon-border">
